...
export function createPaanOrder(basePaan, customizations) {
  // Your code here
  if (!basePaan || typeof basePaan !== "object" || Array.isArray(basePaan)) {
    return {};
  }
...
export function updatePrices(menu, increase) {
  // Your code here
  if (!menu || typeof menu !== "object" || Array.isArray(menu) || typeof increase !== "number") {
    return {};
  }
...
export function mergeDailySpecials(regularMenu, specialsMenu) {
  // Your code here
  if ((regularMenu && typeof regularMenu !== "object") || (specialsMenu && typeof specialsMenu !== "object") || Array.isArray(regularMenu) || Array.isArray(specialsMenu)) {
    return {};
  }
  const regMenu = (regularMenu && typeof regularMenu === "object" && !Array.isArray(regularMenu)) ? regularMenu : {};
  const specMenu = (specialsMenu && typeof specialsMenu === "object" && !Array.isArray(specialsMenu)) ? specialsMenu : {};
