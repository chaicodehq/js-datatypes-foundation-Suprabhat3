...
export function writePostcard(sender, receiver, message) {
  // Your code here
  if (typeof sender !== "string" || typeof receiver !== "string" || typeof message !== "string") { return ""; } sender = sender.trim(); receiver = receiver.trim(); message = message.trim(); if (sender === "" || receiver === "" || message === "") { return ""; } return `Priy ${receiver},\n\n${message}\n\nAapka/Aapki,\n${sender}`;
}

export function isValidPincode(code) {
  // Your code here
if (typeof code !== "string") {return false; } if (code.startsWith("0") || code.length !== 6 || !/^\d+$/.test(code)) { return false; } return true;
}

export function formatPostcardField(label, value, width) {
  // Your code here
  if (typeof label !== "string" || typeof value !== "string") { return ""; } width = width || 12; return label.padEnd(width) + ": " + value;
}

export function isFromState(address, stateCode) {
  // Your code here
if (typeof address !== "string" || typeof stateCode !== "string") { return false; } return address.endsWith(stateCode);
}

export function countVowels(message) {
  // Your code here
  if (typeof message !== "string") { return 0; } const matches = message.match(/[aeiouAEIOU]/g); return matches ? matches.length : 0
}
;